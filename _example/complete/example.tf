...
module "api-gateway" {
  ...
  uri                      = ["", "arn:aws:apigateway:eu-west-1:lambda:path/2015-03-31/functions/arn:aws:lambda:eu-west-1:012345678901:function:test/invocations"]
...
EOF
  ...
  authorizer_credentials          = ["arn:aws:iam::123144197303:role/alarm-lambda-role", "arn:aws:iam::123456789098:role/lambda-role"]
